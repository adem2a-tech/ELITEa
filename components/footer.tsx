  ...
  return (
    <footer className="border-t border-primary-foreground/[0.06] bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        {/* Top CTA bar */}
        <div className="mb-16 flex flex-col items-center gap-6 rounded-2xl border border-primary-foreground/[0.06] bg-primary-foreground/[0.03] p-10 text-center lg:flex-row lg:justify-between lg:text-left">
          <div>
          ...
          <Link
            href="/#contact"
            className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-primary-foreground px-6 py-3.5 text-sm font-semibold text-primary transition-all duration-300 hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-blue-500/20"
          >
            Nous contacter
